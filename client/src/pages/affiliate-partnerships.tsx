...
import professionalImage from '@assets/Building software today that will transform the world we live in tomorrow. II_1751993375468.png';
        ...
        <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative lg:ml-8">
              <div className="relative rounded-2xl shadow-2xl overflow-hidden transform rotate-3 hover:rotate-0 transition-transform duration-500">
                <img 
                  src={professionalImage} 
                  alt="Professional with phone representing successful affiliate partnerships"
                  className="w-full h-auto object-cover rounded-2xl"
                />
                
                {/* Overlay earnings card */}
