#!/usr/bin/env python3
"""
Rapid micro-batch processing - continue import
"""
import pandas as pd
import psycopg2
import os
...
print(f"Current: {start_count:,} cities")

# Process next segment
start_row = 55000
batch_size = 600
max_batches = 25  # 15,000 rows
...
for batch in range(max_batches):
    ...
    if cities_data:
        ...
        print(f"{batch+1:2d}: +{len(cities_data):3d} (rows {row_start:,}-{row_end:,})")
