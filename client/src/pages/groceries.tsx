...
export default function GroceriesPage() {
  ...
  // Translatable texts - Groceries-related
  const texts = useMemo(() => [
    "Groceries",
    "Shopping",
    "item",
    ...
    "No grocery items available yet.",
    ...
    "Share with Member",
    "Would you like to add a message with this item share?",
  ...
  // Fetch products - only groceries
  const { data: products = [], isLoading } = useQuery<Product[]>({
    queryKey: ['/api/products', { categories: 'groceries' }],
    queryFn: async () => {
      // Fetch only grocery items
      const params = new URLSearchParams();
      params.append('categories', 'groceries');
