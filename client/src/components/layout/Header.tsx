    ...
    <header className="bg-background shadow-sm sticky top-0 z-50">
      <div className="container mx-auto px-4">
        ...
        <div className="flex border-b border-gray-200 -mb-px">
          ...
          <div className="flex-1">
            <div
              className={`w-full py-4 text-center text-sm relative cursor-pointer ${(location === '/products' || location === '/' || location.startsWith('/product') || location.startsWith('/vendors') || location.startsWith('/cart') || location.startsWith('/checkout')) ? 'text-black font-bold border-b-2 border-black' : 'text-gray-600 font-medium hover:text-primary'}`}
              onClick={() => {
            ...
            >
              <i className="ri-store-3-line mr-1"></i> Marketplaces
            </div>
          </div>
