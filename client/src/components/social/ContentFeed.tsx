          ...
          <CardContent className="p-3">
            <div className="grid grid-cols-3 gap-2">
              <Button 
                ...
                className={`w-full ${feedType === 'personal' ? "bg-gray-700 hover:bg-gray-800 text-white" : ""}`} 
              ...
              <Button 
                ...
                className={`w-full ${feedType === 'communities' ? "bg-gray-700 hover:bg-gray-800 text-white" : ""}`} 
              ...
              <Button 
                ...
                className={`w-full ${feedType === 'recommended' ? "bg-gray-700 hover:bg-gray-800 text-white" : ""}`} 
        ...
        <CardContent className="p-3">
          <div className="grid grid-cols-2 gap-2">
            <Button 
              ...
              className={`w-full ${sortType === 'relevant' ? "bg-gray-700 hover:bg-gray-800 text-white" : ""}`} 
            ...
            <Button 
              ...
              className={`w-full ${sortType === 'recent' ? "bg-gray-700 hover:bg-gray-800 text-white" : ""}`} 
