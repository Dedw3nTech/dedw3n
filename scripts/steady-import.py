#!/usr/bin/env python3
"""
Steady import - continue from row 70,000
"""
import pandas as pd
import psycopg2
import os
...
print(f"Starting: {start_count:,}")

# Steady processing
start_row = 70000
batch_size = 700
max_batches = 20  # 14,000 rows
...
for batch in range(max_batches):
    ...
    if cities_data:
        ...
        print(f"{batch+1}: +{len(cities_data)} cities")
