...
interface DatingMessagingProps {
  embedded?: boolean;
  initialUserId?: number;
}

export function DatingMessaging({ embedded = false, initialUserId }: DatingMessagingProps) {
  const { user } = useAuth();
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="text-gray-500">Please log in to access dating messages</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col h-full bg-white rounded-lg overflow-hidden border">
      {/* Header */}
      <div className="p-4 border-b bg-gradient-to-r from-pink-50 to-red-100">
        <div className="flex items-center gap-3">
          <div className="p-2 bg-gradient-to-r from-pink-500 to-red-500 rounded-lg">
            <Heart className="h-5 w-5 text-white" />
          </div>
          <div>
            <h3 className="text-lg font-semibold text-gray-900">Dating Messages</h3>
            <p className="text-sm text-gray-600">Connect with your matches</p>
          </div>
          {unreadData?.count > 0 && (
            <Badge className="ml-auto bg-gradient-to-r from-pink-500 to-red-500 text-white">
              {unreadData.count}
            </Badge>
          )}
        </div>
            ...
            <div className="space-y-2 p-4">
              {conversations.length === 0 ? (
                <div className="text-center py-10 text-muted-foreground">
                  ...
                  <p className="text-lg font-medium">No dating conversations</p>
                ...
                conversations.map((convo) => (
                  <Card
                    key={convo.id}
                    className="cursor-pointer hover:shadow-md transition-shadow border-l-4 border-l-pink-500"
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center gap-3">
                        <div className="relative">
                          ...
                          <div className="absolute -bottom-1 -right-1 p-1 bg-pink-500 rounded-full">
                        ...
                        <div className="flex-1 overflow-hidden">
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            <Badge variant="outline" className="text-xs bg-gradient-to-r from-pink-50 to-red-50">
        ...
        <>
          ...
          <div className="p-4 border-b">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <h4 className="font-medium">Dating Chat</h4>
              ...
              <div className="space-y-4">
                {messages.length === 0 ? (
                  <div className="text-center py-10 text-muted-foreground">
                    ...
                    <p className="text-sm">Say hello and get to know each other</p>
                  </div>
                ) : (
                        ...
                        >
                          ...
                          <span
                            className={`text-xs mt-1 block text-right ${
                              isMine ? 'text-pink-100' : 'text-gray-500'
                            }`}
                          >
          ...
          <div className="p-4 border-t">
            <form onSubmit={handleSendMessage} className="flex gap-2">
              ...
              <Button type="button" variant="outline" size="sm" className="border-pink-200 hover:bg-pink-50">
                <Paperclip className="h-4 w-4 text-pink-600" />
              </Button>
              <Button type="button" variant="outline" size="sm" className="border-pink-200 hover:bg-pink-50">
                <ImageIcon className="h-4 w-4 text-pink-600" />
              </Button>
              <Button type="submit" className="bg-gradient-to-r from-pink-500 to-red-500 hover:from-pink-600 hover:to-red-600">
