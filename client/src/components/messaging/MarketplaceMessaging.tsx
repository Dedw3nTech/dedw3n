...
export function MarketplaceMessaging({ embedded = false, initialUserId }: MarketplaceMessagingProps) {
  const { user } = useAuth();
  ...
  const { data: conversations = [], isLoading: isLoadingConversations, refetch: refetchConversations } = useQuery<Conversation[]>({
    queryKey: ['/api/messages/conversations/marketplace'],
    enabled: user !== null,
  });

  // Fetch marketplace messages for active chat
  ...
  // Fetch unread count for marketplace
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="text-gray-500">Please log in to access marketplace messaging</p>
        </div>
      </div>
    );
  }
    ...
    <div className="flex flex-col h-full bg-white rounded-lg overflow-hidden border">
      ...
      <div className="p-4 border-b bg-gradient-to-r from-blue-50 to-blue-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900">Marketplace Messages</h3>
            <p className="text-sm text-gray-600">Buy, sell, and negotiate deals</p>
          </div>
          {unreadData?.count > 0 && (
            ...
            <div className="space-y-2 p-4">
              {conversations.length === 0 ? (
                <div className="text-center py-10 text-muted-foreground">
                  ...
                  <p className="text-lg font-medium">No marketplace conversations</p>
                  <p className="text-sm">Start buying or selling to begin conversations</p>
                </div>
              ) : (
          ...
          <div className="p-4 border-b">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <h4 className="font-medium">Marketplace Chat</h4>
              ...
              <div className="space-y-4">
                {messages.length === 0 ? (
                  <div className="text-center py-10 text-muted-foreground">
                    ...
                    <p className="text-sm">Discuss products, prices, and delivery details</p>
                  </div>
                ) : (
            ...
            <form onSubmit={handleSendMessage} className="flex gap-2">
              <div className="flex-1 relative">
                <input
                  ...
                  placeholder="Type your message about products, prices..."
