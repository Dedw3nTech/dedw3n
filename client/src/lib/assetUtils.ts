...
export const ENCODED_ASSETS = {
  // Video assets
  CAR_SELLING_VIDEO: '/attached_assets/car%20selling%20online%20%20_1749419270298.mp4',
  ...
  // Hero/Landing images
  COMING_SOON_DESKTOP: '/attached_assets/coming%20soon%20carte%20blanche_1761364163382.png',
  COMING_SOON_MOBILE: '/attached_assets/coming%20soon%20web%20app%20mobile_1758821892697.png',
  
  // Business headers
  BUSINESS_B2B_HEADER: '/attached_assets/Dedw3n%20Business%20B2B%20Header.png',
  BUSINESS_B2C_HEADER: '/attached_assets/Dedw3n%20Business%20B2C%20Header%20new_1749416893159.png',
  BUSINESS_C2C_HEADER: '/attached_assets/Dedw3n%20Business%20C2c%20header_1749418133958.png',
  
  // Business footers  
  BUSINESS_B2B_FOOTER: '/attached_assets/Dedw3n%20Business%20B2B%20Footer.png',
  BUSINESS_B2C_FOOTER: '/attached_assets/Dedw3n%20Business%20B2C%20Footer%20new%202_1749417170052.png',
  ...
  // Marketplace images
  MARKETPLACE_PROMO: '/attached_assets/Copy%20of%20Dedw3n%20Marketplace%20II.png',
  MARKETPLACE_FALLBACK: '/attached_assets/Copy%20of%20Dedw3n%20Marketplace.png',
  MARKETPLACE_FOOTER: '/attached_assets/Copy%20of%20Dedw3n%20Marketplace%20III.png',
  ...
  AFFILIATE_PARTNERSHIP: '/attached_assets/affiliate%20partnership%202_1754329999391.png',
  CAMPAIGN_SELL: '/attached_assets/Copy%20of%20Copy%20of%20Pre%20Launch%20Campaign%20%20SELL%20(1).png',
  
  // Business content images (with numbers)
  BUSINESS_CONTENT_5: '/attached_assets/Dedw3n%20Business%20%20(5)_1753733900980.png',
  
  // Community and communication
  COMMUNITY_COMM_HEADER: '/attached_assets/Dedw3n%20Business%20commHeader.png',
  COMMUNITY_COMM_FOOTER: '/attached_assets/Dedw3n%20comm%20Footer_1749108826266.png',
  
  // Long filename assets  
  WORLD_TOMORROW: '/attached_assets/Copy%20of%20We%20are%20developing%20software%20today%20that%20will%20facilitate%20business%20operations%20in%20the%20world%20of%20tomorrow._1751998175092.png',
  AFFILIAT_PARTNERSHIP_3: '/attached_assets/Affiliat%20partnership%203_1753733859529.png',
} as const;