            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="relative">
                  ...
                  <Input
                    placeholder="Search Dating Profiles"
                    value={searchTerm}
          ...
          <div className="space-y-3 max-h-96 overflow-y-auto">
            <div className="bg-gray-50 border border-gray-200 rounded-md p-4 mb-4">
              ...
              <p className="text-xs text-gray-700 leading-relaxed">
                When you send a gift, the recipient will receive an approval message and can choose to accept or refuse. If accepted, both users will automatically match and you will receive a payment link to complete the purchase. By accepting your gift, the recipient is under no obligation to perform any action or entertain the sender; it is merely a token of appreciation within the African culture. The recipient retains the right to reject, refund, or keep the gift without any expectation of counter-performance. Please note that Dedw3n Ltd. does not provide refunds for gifts. By clicking the "Send Gift" button, you acknowledge, understand and accept the (T&C's) terms and conditions, as well as the disclaimer.
              </p>
            </div>
