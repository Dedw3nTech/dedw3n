...
export default function JobsPage() {
  ...
  // Translatable texts - Job-related
  const texts = useMemo(() => [
    "Jobs",
    "Opportunities",
    "job",
    ...
    "Share with Member",
    "Would you like to add a message with this job share?",
    "Add your message (optional)",
    "Send Offer",
    "Send a price offer to the job poster",
    "Your Offer Amount",
  ...
  // Fetch products - only jobs
  const { data: products = [], isLoading } = useQuery<Product[]>({
    queryKey: ['/api/products', { categories: 'jobs' }],
    queryFn: async () => {
      // Fetch only jobs
      const params = new URLSearchParams();
      params.append('categories', 'jobs');
