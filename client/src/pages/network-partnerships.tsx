          ...
          <div className="lg:col-span-2 relative">
            <div className="relative h-full">
              ...
              <div className="absolute inset-0 bg-black bg-opacity-40 rounded-2xl flex items-center justify-center">
                <div className="text-center text-white p-8 backdrop-blur-sm bg-black bg-opacity-30 rounded-lg">
          ...
          <div className="space-y-6">
            <div className="relative h-44">
              <img 
                ...
                alt="Business Operations Tomorrow"
                className="w-full h-full object-cover rounded-2xl shadow-lg"
              />
              <div className="absolute bottom-3 left-3 bg-black bg-opacity-70 text-white px-3 py-1 rounded-md text-sm font-medium backdrop-blur-sm">
