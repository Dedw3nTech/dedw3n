...
export default function FreelancePage() {
  ...
  // Translatable texts - Freelance-related
  const texts = useMemo(() => [
    "Freelance",
    "Opportunities",
    "gig",
    "gigs",
    "found",
    "No freelance gigs found matching your search.",
    "No freelance gigs available yet.",
    ...
    "Share with Member",
    "Would you like to add a message with this gig share?",
    "Add your message (optional)",
    "Send Offer",
    "Send a price offer to the gig poster",
    "Your Offer Amount",
  ...
  // Fetch products - only freelance gigs
  const { data: products = [], isLoading } = useQuery<Product[]>({
    queryKey: ['/api/products', { categories: 'freelance' }],
    queryFn: async () => {
      // Fetch only freelance gigs
      const params = new URLSearchParams();
      params.append('categories', 'freelance');
