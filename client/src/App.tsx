...
import b2cHeaderImage from "@assets/Dedw3n Business B2C Header.png";
...
const marketPromoImages = {
  b2c: {
    top: b2cHeaderImage, // Currently: Dedw3n Business B2C Header.png (elegant professional business people with sophisticated styling)
